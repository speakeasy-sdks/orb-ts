 ...
 */
export enum FetchCustomerCostsExternalIdViewMode {
    Periodic = "periodic",
    Cumulative = "cumulative",
}

export class FetchCustomerCostsExternalIdRequest extends SpeakeasyBase {
...
export class FetchCustomerCostsExternalId200ApplicationJSONDataPerPriceCostsPriceGroups extends SpeakeasyBase {
    /**
 ...
 */
export class FetchCustomerCostsExternalId200ApplicationJSONDataPerPriceCosts extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata({
        elemType: FetchCustomerCostsExternalId200ApplicationJSONDataPerPriceCostsPriceGroups,
    })
    @Expose({ name: "price_groups" })
    @Type(() => FetchCustomerCostsExternalId200ApplicationJSONDataPerPriceCostsPriceGroups)
    priceGroups: FetchCustomerCostsExternalId200ApplicationJSONDataPerPriceCostsPriceGroups[];
...
export class FetchCustomerCostsExternalId200ApplicationJSONData extends SpeakeasyBase {
    @SpeakeasyMetadata({
        elemType: FetchCustomerCostsExternalId200ApplicationJSONDataPerPriceCosts,
    })
    @Expose({ name: "per_price_costs" })
    @Type(() => FetchCustomerCostsExternalId200ApplicationJSONDataPerPriceCosts)
    perPriceCosts: FetchCustomerCostsExternalId200ApplicationJSONDataPerPriceCosts[];
 ...
 * OK
 */
export class FetchCustomerCostsExternalId200ApplicationJSON extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: FetchCustomerCostsExternalId200ApplicationJSONData })
    @Expose({ name: "data" })
    @Type(() => FetchCustomerCostsExternalId200ApplicationJSONData)
    data: FetchCustomerCostsExternalId200ApplicationJSONData[];
...
export class FetchCustomerCostsExternalIdResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
