...
export class GetExternalCustomerCostsRequest extends SpeakeasyBase {
 ...
 */
export class GetExternalCustomerCosts200ApplicationJSONDataPerPriceCosts extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata({
        elemType: GetExternalCustomerCosts200ApplicationJSONDataPerPriceCostsPriceGroups,
    })
    @Expose({ name: "price_groups" })
    @Type(() => GetExternalCustomerCosts200ApplicationJSONDataPerPriceCostsPriceGroups)
    priceGroups: GetExternalCustomerCosts200ApplicationJSONDataPerPriceCostsPriceGroups[];
...
export class GetExternalCustomerCosts200ApplicationJSONData extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: GetExternalCustomerCosts200ApplicationJSONDataPerPriceCosts })
    @Expose({ name: "per_price_costs" })
    @Type(() => GetExternalCustomerCosts200ApplicationJSONDataPerPriceCosts)
    perPriceCosts: GetExternalCustomerCosts200ApplicationJSONDataPerPriceCosts[];
 ...
 * OK
 */
export class GetExternalCustomerCosts200ApplicationJSON extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: GetExternalCustomerCosts200ApplicationJSONData })
    @Expose({ name: "data" })
    @Type(() => GetExternalCustomerCosts200ApplicationJSONData)
    data: GetExternalCustomerCosts200ApplicationJSONData[];
...
export class GetExternalCustomerCostsResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
