...
export enum AddLedgerEntryExternalIdRequestBodyEntryType {
    Increment = "increment",
    Decrement = "decrement",
 ...
 */
export class AddLedgerEntryExternalIdRequestBodyInvoiceSettings extends SpeakeasyBase {
    /**
 ...
 */
export class AddLedgerEntryExternalIdRequestBodyMetadata extends SpeakeasyBase {}

export class AddLedgerEntryExternalIdRequestBody extends SpeakeasyBase {
    /**
    ...
    entryType: AddLedgerEntryExternalIdRequestBodyEntryType;
    ...
    @Type(() => AddLedgerEntryExternalIdRequestBodyInvoiceSettings)
    invoiceSettings?: AddLedgerEntryExternalIdRequestBodyInvoiceSettings;
    ...
    @Type(() => AddLedgerEntryExternalIdRequestBodyMetadata)
    metadata?: AddLedgerEntryExternalIdRequestBodyMetadata;
...
export class AddLedgerEntryExternalIdRequest extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "request, media_type=application/json" })
    requestBody?: AddLedgerEntryExternalIdRequestBody;

    @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=external_customer_id" })
    externalCustomerId: string;
}

export class AddLedgerEntryExternalIdResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
