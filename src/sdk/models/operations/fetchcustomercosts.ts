 ...
 */
export enum FetchCustomerCostsViewMode {
    Periodic = "periodic",
    Cumulative = "cumulative",
}

export class FetchCustomerCostsRequest extends SpeakeasyBase {
    /**
     * The Orb Customer ID
     */
    ...
    viewMode?: FetchCustomerCostsViewMode;
}

export class FetchCustomerCosts200ApplicationJSONDataPerPriceCostsPriceGroups extends SpeakeasyBase {
    /**
 ...
 */
export class FetchCustomerCosts200ApplicationJSONDataPerPriceCosts extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata({
        elemType: FetchCustomerCosts200ApplicationJSONDataPerPriceCostsPriceGroups,
    })
    @Expose({ name: "price_groups" })
    @Type(() => FetchCustomerCosts200ApplicationJSONDataPerPriceCostsPriceGroups)
    priceGroups: FetchCustomerCosts200ApplicationJSONDataPerPriceCostsPriceGroups[];
...
export class FetchCustomerCosts200ApplicationJSONData extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: FetchCustomerCosts200ApplicationJSONDataPerPriceCosts })
    @Expose({ name: "per_price_costs" })
    @Type(() => FetchCustomerCosts200ApplicationJSONDataPerPriceCosts)
    perPriceCosts: FetchCustomerCosts200ApplicationJSONDataPerPriceCosts[];
 ...
 * OK
 */
export class FetchCustomerCosts200ApplicationJSON extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: FetchCustomerCosts200ApplicationJSONData })
    @Expose({ name: "data" })
    @Type(() => FetchCustomerCosts200ApplicationJSONData)
    data: FetchCustomerCosts200ApplicationJSONData[];
...
export class FetchCustomerCostsResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
