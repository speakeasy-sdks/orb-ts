 ...
 */
export enum GetCustomerCostsViewMode {
  Periodic = "periodic",
...
export class GetCustomerCostsRequest extends SpeakeasyBase {
  ...
  viewMode?: GetCustomerCostsViewMode;
}
...
export class GetCustomerCosts200ApplicationJSONDataPerPriceCosts extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    elemType: GetCustomerCosts200ApplicationJSONDataPerPriceCostsPriceGroups,
  })
...
export class GetCustomerCosts200ApplicationJSONData extends SpeakeasyBase {
  @SpeakeasyMetadata({
    elemType: GetCustomerCosts200ApplicationJSONDataPerPriceCosts,
  })
