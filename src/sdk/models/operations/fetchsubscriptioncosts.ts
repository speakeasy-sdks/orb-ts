...
export class FetchSubscriptionCostsRequest extends SpeakeasyBase {
    /**
...
export class FetchSubscriptionCosts200ApplicationJSONDataPerPriceCostsPriceGroups extends SpeakeasyBase {
    /**
 ...
 */
export class FetchSubscriptionCosts200ApplicationJSONDataPerPriceCosts extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata({
        elemType: FetchSubscriptionCosts200ApplicationJSONDataPerPriceCostsPriceGroups,
    })
    @Expose({ name: "price_groups" })
    @Type(() => FetchSubscriptionCosts200ApplicationJSONDataPerPriceCostsPriceGroups)
    priceGroups: FetchSubscriptionCosts200ApplicationJSONDataPerPriceCostsPriceGroups[];
...
export class FetchSubscriptionCosts200ApplicationJSONData extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: FetchSubscriptionCosts200ApplicationJSONDataPerPriceCosts })
    @Expose({ name: "per_price_costs" })
    @Type(() => FetchSubscriptionCosts200ApplicationJSONDataPerPriceCosts)
    perPriceCosts: FetchSubscriptionCosts200ApplicationJSONDataPerPriceCosts[];
 ...
 * OK
 */
export class FetchSubscriptionCosts200ApplicationJSON extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: FetchSubscriptionCosts200ApplicationJSONData })
    @Expose({ name: "data" })
    @Type(() => FetchSubscriptionCosts200ApplicationJSONData)
    data: FetchSubscriptionCosts200ApplicationJSONData[];
...
export class FetchSubscriptionCostsResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
