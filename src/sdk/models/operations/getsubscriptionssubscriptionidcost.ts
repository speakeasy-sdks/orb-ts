...
export class GetSubscriptionsSubscriptionIdCost200ApplicationJSONDataPerPriceCosts extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({
    elemType:
      GetSubscriptionsSubscriptionIdCost200ApplicationJSONDataPerPriceCostsPriceGroups,
  })
...
export class GetSubscriptionsSubscriptionIdCost200ApplicationJSONData extends SpeakeasyBase {
  @SpeakeasyMetadata({
    elemType:
      GetSubscriptionsSubscriptionIdCost200ApplicationJSONDataPerPriceCosts,
  })
...
export class GetSubscriptionsSubscriptionIdCost200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata({
    elemType: GetSubscriptionsSubscriptionIdCost200ApplicationJSONData,
  })
  @Expose({ name: "data" })
