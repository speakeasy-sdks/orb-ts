...
export class GetSubscriptionsSubscriptionIdCostRequest extends SpeakeasyBase {
    /**
...
export class GetSubscriptionsSubscriptionIdCost200ApplicationJSONDataPerPriceCostsPriceGroups extends SpeakeasyBase {
    /**
 ...
 */
export class GetSubscriptionsSubscriptionIdCost200ApplicationJSONDataPerPriceCosts extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata({
        elemType: GetSubscriptionsSubscriptionIdCost200ApplicationJSONDataPerPriceCostsPriceGroups,
    })
    @Expose({ name: "price_groups" })
    @Type(() => GetSubscriptionsSubscriptionIdCost200ApplicationJSONDataPerPriceCostsPriceGroups)
    priceGroups: GetSubscriptionsSubscriptionIdCost200ApplicationJSONDataPerPriceCostsPriceGroups[];
...
export class GetSubscriptionsSubscriptionIdCost200ApplicationJSONData extends SpeakeasyBase {
    @SpeakeasyMetadata({
        elemType: GetSubscriptionsSubscriptionIdCost200ApplicationJSONDataPerPriceCosts,
    })
    @Expose({ name: "per_price_costs" })
    @Type(() => GetSubscriptionsSubscriptionIdCost200ApplicationJSONDataPerPriceCosts)
    perPriceCosts: GetSubscriptionsSubscriptionIdCost200ApplicationJSONDataPerPriceCosts[];
 ...
 * OK
 */
export class GetSubscriptionsSubscriptionIdCost200ApplicationJSON extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: GetSubscriptionsSubscriptionIdCost200ApplicationJSONData })
    @Expose({ name: "data" })
    @Type(() => GetSubscriptionsSubscriptionIdCost200ApplicationJSONData)
    data: GetSubscriptionsSubscriptionIdCost200ApplicationJSONData[];
...
export class GetSubscriptionsSubscriptionIdCostResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
