 ...
 */
export class InvoiceLineItemSubLineItemsGrouping extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "key" })
    key?: string;
 ...
 */
export class InvoiceLineItemSubLineItemsMatrixConfig extends SpeakeasyBase {
    /**
 ...
 */
export class InvoiceLineItemSubLineItemsTierConfig extends SpeakeasyBase {
    @SpeakeasyMetadata()
 ...
 */
export enum InvoiceLineItemSubLineItemsType {
    Matrix = "matrix",
    Tier = "tier",
}

export class InvoiceLineItemSubLineItems extends SpeakeasyBase {
    /**
    ...
    @Type(() => InvoiceLineItemSubLineItemsGrouping)
    grouping: InvoiceLineItemSubLineItemsGrouping;
    ...
    @Type(() => InvoiceLineItemSubLineItemsMatrixConfig)
    matrixConfig?: InvoiceLineItemSubLineItemsMatrixConfig;
    ...
    @Type(() => InvoiceLineItemSubLineItemsTierConfig)
    tierConfig?: InvoiceLineItemSubLineItemsTierConfig;
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "type" })
    type: InvoiceLineItemSubLineItemsType;
}

export class InvoiceLineItemTaxAmounts extends SpeakeasyBase {
    /**
...
/**
 * The component line of an [Invoice](../reference/Orb-API.json/components/schemas/Invoice)
 */
export class InvoiceLineItem extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata({ elemType: InvoiceLineItemSubLineItems })
    @Expose({ name: "sub_line_items" })
    @Type(() => InvoiceLineItemSubLineItems)
    subLineItems: InvoiceLineItemSubLineItems[];
     ...
     */
    @SpeakeasyMetadata({ elemType: InvoiceLineItemTaxAmounts })
    @Expose({ name: "tax_amounts" })
    @Type(() => InvoiceLineItemTaxAmounts)
    taxAmounts: InvoiceLineItemTaxAmounts[];
}
