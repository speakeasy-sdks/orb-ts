...
export class Customer {
  ...
  getBalance(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetCustomersCustomerIdBalanceTransactionsRequest(
        req
      );
    }
  ...
  getByExternalId(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetCustomersExternalCustomerIdExternalCustomerIdRequest(
          req
        );
    }
  ...
  updateByExternalId(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.PutCustomersExternalCustomerIdExternalCustomerIdRequest(
          req
        );
    }
