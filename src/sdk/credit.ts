...
export class Credit {
     ...
     */
    async addByExternalId(
        req: operations.AddLedgerEntryExternalIdRequest,
        config?: AxiosRequestConfig
    ): Promise<operations.AddLedgerEntryExternalIdResponse> {
        ...
        const res: operations.AddLedgerEntryExternalIdResponse =
            new operations.AddLedgerEntryExternalIdResponse({
     ...
     */
    async create(
        req: operations.CreateLedgerEntryRequest,
        config?: AxiosRequestConfig
        ...
        const res: operations.CreateLedgerEntryResponse = new operations.CreateLedgerEntryResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
     ...
     */
    async fetch(
        req: operations.FetchCustomerCreditsRequest,
        config?: AxiosRequestConfig
        ...
        const url: string = utils.generateURL(baseURL, "/customers/{customer_id}/credits", req);
        ...
        const res: operations.FetchCustomerCreditsResponse =
            new operations.FetchCustomerCreditsResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.fetchCustomerCredits200ApplicationJSONObject = utils.objectToClass(
                        httpRes?.data,
                        operations.FetchCustomerCredits200ApplicationJSON
                    );
                }
                break;
        }
    ...
    async fetchByExternalId(
        req: operations.FetchCustomerCreditsExternalIdRequest,
        config?: AxiosRequestConfig
        ...
        const res: operations.FetchCustomerCreditsExternalIdResponse =
            new operations.FetchCustomerCreditsExternalIdResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.fetchCustomerCreditsExternalId200ApplicationJSONObject =
                        utils.objectToClass(
                            httpRes?.data,
                            operations.FetchCustomerCreditsExternalId200ApplicationJSON
                        );
                }
                break;
        }
    ...
    async fetchLedger(
        ...
        const res: operations.FetchCustomerCreditsLedgerResponse =
            new operations.FetchCustomerCreditsLedgerResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.fetchCustomerCreditsLedger200ApplicationJSONObject = utils.objectToClass(
                        httpRes?.data,
                        operations.FetchCustomerCreditsLedger200ApplicationJSON
                    );
                }
                break;
        }
    ...
    async fetchLedgerByExternalId(
        ...
        const res: operations.FetchCustomerCreditsLedgerExternalIdResponse =
            new operations.FetchCustomerCreditsLedgerExternalIdResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.fetchCustomerCreditsLedgerExternalId200ApplicationJSONObject =
                        utils.objectToClass(
                            httpRes?.data,
                            operations.FetchCustomerCreditsLedgerExternalId200ApplicationJSON
                        );
                }
                break;
        }
