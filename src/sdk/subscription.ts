...
export class Subscription {
  ...
  async changeSchedule(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.PostSubscriptionsSubscriptionIdSchedulePlanChangeRequest(
          req
        );
    }
  ...
  async unschedule(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.PostSubscriptionsSubscriptionIdUnschedulePendingPlanChangesRequest(
          req
        );
    }
