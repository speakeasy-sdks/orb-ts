...
export class Subscription {
        ...
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.subscription = utils.objectToClass(httpRes?.data, shared.Subscription);
                }
                break;
        }
    ...
    async fetch(
        ...
        const res: operations.FetchSubscriptionResponse = new operations.FetchSubscriptionResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
    ...
    async fetchCosts(
        ...
        const res: operations.FetchSubscriptionCostsResponse =
            new operations.FetchSubscriptionCostsResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.fetchSubscriptionCosts200ApplicationJSONObject = utils.objectToClass(
                        httpRes?.data,
                        operations.FetchSubscriptionCosts200ApplicationJSON
                    );
                }
                break;
        }
     ...
     */
    async fetchSchedule(
        req: operations.FetchSubscriptionScheduleRequest,
        config?: AxiosRequestConfig
        ...
        const res: operations.FetchSubscriptionScheduleResponse =
            new operations.FetchSubscriptionScheduleResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.fetchSubscriptionSchedule200ApplicationJSONObject = utils.objectToClass(
                        httpRes?.data,
                        operations.FetchSubscriptionSchedule200ApplicationJSON
                    );
                }
                break;
        }
    ...
    async fetchUsage(
        ...
        const res: operations.FetchSubscriptionUsageResponse =
            new operations.FetchSubscriptionUsageResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.fetchSubscriptionUsage200ApplicationJSONObject = utils.objectToClass(
                        httpRes?.data,
                        operations.FetchSubscriptionUsage200ApplicationJSON
                    );
                }
                break;
        }
    ...
    async schedulePlanChange(
        req: operations.SchedulePlanChangeRequest,
        config?: AxiosRequestConfig
    ): Promise<operations.SchedulePlanChangeResponse> {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SchedulePlanChangeRequest(req);
        }
        ...
        const res: operations.SchedulePlanChangeResponse =
            new operations.SchedulePlanChangeResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    async unscheduleCancellation(
        req: operations.UnscheduleCancellationRequest,
        config?: AxiosRequestConfig
    ): Promise<operations.UnscheduleCancellationResponse> {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UnscheduleCancellationRequest(req);
        }
        ...
        const res: operations.UnscheduleCancellationResponse =
            new operations.UnscheduleCancellationResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     */
    async unschedulePlanChange(
        req: operations.UnschedulePlanChangeRequest,
        config?: AxiosRequestConfig
    ): Promise<operations.UnschedulePlanChangeResponse> {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UnschedulePlanChangeRequest(req);
        }
        ...
        const res: operations.UnschedulePlanChangeResponse =
            new operations.UnschedulePlanChangeResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     */
    async updateFixedFeeQuantity(
        req: operations.UpdateFixedFeeQuantityRequest,
        config?: AxiosRequestConfig
    ): Promise<operations.UpdateFixedFeeQuantityResponse> {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UpdateFixedFeeQuantityRequest(req);
        }
        ...
        const res: operations.UpdateFixedFeeQuantityResponse =
            new operations.UpdateFixedFeeQuantityResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
