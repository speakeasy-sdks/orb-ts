...
export class Subscription {
    ...
    async create(
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostSubscriptionsRequestBody(req);
        }
        ...
        const res: operations.PostSubscriptionsResponse = new operations.PostSubscriptionsResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
    ...
    async getCost(
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetSubscriptionsSubscriptionIdCostRequest(req);
        }
    ...
    async unschedule(
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostSubscriptionsSubscriptionIdUnschedulePendingPlanChangesRequest(
                req
            );
        }
