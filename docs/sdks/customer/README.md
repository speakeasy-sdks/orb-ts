...
**Promise<[operations.PostCustomersCustomerIdBalanceTransactionsResponse](../../models/operations/postcustomerscustomeridbalancetransactionsresponse.md)>**
...
sdk.customer.fetchCostsByExternalId({
  ...
  timeframeEnd: "2022-03-01T05:00:00Z",
  timeframeStart: new Date("2022-02-01T05:00:00Z"),
  viewMode: FetchCustomerCostsExternalIdViewMode.Periodic,
...
sdk.customer.updateByExternalId({
  requestBody: {
    ...
    name: "Edna Pouros",
    paymentProvider: UpdateCustomerExternalIdRequestBodyPaymentProvider.Null,
    paymentProviderId: "modi",
    shippingAddress: {
      city: "Judahshire",
      country: "US",
      line1: "quasi",
      line2: "repudiandae",
      postalCode: "09230-6816",
      state: "distinctio",
    },
  },
...
sdk.customer.updateCustomer({
  requestBody: {
    ...
    metadata: {},
    name: "Sergio Hyatt",
    paymentProvider: UpdateCustomerRequestBodyPaymentProvider.BillCom,
    paymentProviderId: "officia",
    shippingAddress: {
      city: "Fort Veda",
      country: "US",
      line1: "dolorum",
