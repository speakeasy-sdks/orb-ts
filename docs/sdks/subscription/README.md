...
sdk.subscription.create("maxime".encode()).then((res: CreateSubscriptionRawResponse) => {
  if (res.statusCode == 200) {
    // handle response
  }
});
...
**Promise<[operations.CreateSubscriptionRawResponse](../../models/operations/createsubscriptionrawresponse.md)>**
...
sdk.subscription.create({
  ...
  couponRedemptionCode: "deleniti",
  customerId: "97DPcZE9hxsbb9Y9",
  defaultInvoiceMemo: "facilis",
  ...
  phaseOverrides: [
    {
      discount: {
        ...
        trialAmountDiscount: "repellat",
        usageDiscount: 8411.4,
      },
      minimumAmount: "sed",
      order: 9046.48,
    },
  ...
  priceOverrides: [
      ...
      bulkBpsConfig: {
        tiers: [
          ...
          },
          {
            bps: 332.22,
            maximumAmount: "ab",
            perUnitMaximum: "maiores",
          },
          {
            bps: 6974.29,
            maximumAmount: "ipsam",
            perUnitMaximum: "voluptate",
          },
        ],
      },
      discount: {
        amountDiscount: "autem",
        discountType: CreateDiscountDiscountType.Amount,
        percentageDiscount: "eaque",
        usageDiscount: "pariatur",
      },
      id: "5f0d30c5-fbb2-4587-8532-02c73d5fe9b9",
      minimumAmount: "1.23",
      modelType: CreateSubscriptionApplicationJSONPriceOverrides6ModelType.BulkBps,
    },
    {
      discount: {
        amountDiscount: "porro",
        discountType: CreateDiscountDiscountType.Percentage,
        percentageDiscount: "blanditiis",
        usageDiscount: "error",
      },
      id: "2dbSXs47wDkmtEME",
      minimumAmount: "1.23",
    ...
    },
    {
      ...
      discount: {
        amountDiscount: "asperiores",
        discountType: CreateDiscountDiscountType.Amount,
        percentageDiscount: "modi",
        usageDiscount: "iste",
      },
...
**Promise<[operations.CreateSubscriptionJsonResponse](../../models/operations/createsubscriptionjsonresponse.md)>**
...
**Promise<[operations.FetchSubscriptionResponse](../../models/operations/fetchsubscriptionresponse.md)>**
...
**Promise<[operations.FetchSubscriptionCostsResponse](../../models/operations/fetchsubscriptioncostsresponse.md)>**
...
**Promise<[operations.FetchSubscriptionScheduleResponse](../../models/operations/fetchsubscriptionscheduleresponse.md)>**
...
**Promise<[operations.FetchSubscriptionUsageResponse](../../models/operations/fetchsubscriptionusageresponse.md)>**
...
sdk.subscription.schedulePlanChange({
  requestBody: {
    ...
    changeOption: SchedulePlanChangeRequestBodyChangeOption.EndOfSubscriptionTerm,
    couponRedemptionCode: "voluptate",
    ...
    priceOverrides: [
      {
        ...
        minimumAmount: "1.23",
        modelType: SchedulePlanChangeRequestBodyPriceOverrides4ModelType.Package,
        packageConfig: {
          numUnits: 1856.36,
          unitAmount: "dolorum",
        },
      },
      {
        ...
        minimumAmount: "1.23",
        modelType: SchedulePlanChangeRequestBodyPriceOverrides7ModelType.TieredBps,
        tieredBpsConfig: {
          tiers: [
            {
              bps: 6748.48,
...
**Promise<[operations.SchedulePlanChangeResponse](../../models/operations/scheduleplanchangeresponse.md)>**
...
**Promise<[operations.UnscheduleCancellationResponse](../../models/operations/unschedulecancellationresponse.md)>**
...
**Promise<[operations.UnschedulePlanChangeResponse](../../models/operations/unscheduleplanchangeresponse.md)>**
...
**Promise<[operations.UpdateFixedFeeQuantityResponse](../../models/operations/updatefixedfeequantityresponse.md)>**
