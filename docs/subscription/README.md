...
sdk.subscription.create({
  ...
  priceOverrides: [
    ...
    {
      discount: {
        amountDiscount: "quidem",
        discountType: CreateDiscountDiscountType.Amount,
        percentageDiscount: "voluptas",
        usageDiscount: "natus",
      },
      id: "280d1ba7-7a89-4ebf-b37a-e4203ce5e6a9",
      minimumAmount: "1.23",
      modelType: CreateSubscriptionApplicationJSONPriceOverrides7ModelType.TieredBps,
      tieredBpsConfig: {
        tiers: [
          {
            bps: 8310.49,
          ...
          tiers: [
            {
              bps: 2048.65,
              maximumAmount: "fugit",
              perUnitMaximum: "magni",
            },
          ],
        },
        id: "715bf0cb-b1e3-41b8-b90f-3443a1108e0a",
        minimumAmount: "1.23",
        modelType: SchedulePlanChangeRequestBodyPriceOverrides6ModelType.BulkBps,
      },
      {
        bulkBpsConfig: {
          tiers: [
